...
**Canonical lib-core:** [`sonus-auris/sonus-auris-lib-core`](https://github.com/sonus-auris/sonus-auris-lib-core)
**ORM package:** `sonus-auris-orm-core` (fold into lib-core; do not keep a second SQL authority)
**Org note:** Shared-platform product (`sonus_auris` schema). Supersedes `docs/ORM_CORE_LIBRARY.md` claims that SeaORM is always the ORM and that schema is imported only from k8s-libs-and-shared-defs.
